...
#NVCCFLAGS += -std=c++11 -Xcompiler "-Wno-deprecated-declarations" -Xlinker "-Wno-deprecated-declarations" -Xarchive "-Wno-deprecated-declarations" -Xnvlink "-Wno-deprecated-declarations"
...
ifeq ($(USE_OPENCV), 1)
	LIBRARIES += OpenNI2 opencv_core opencv_highgui opencv_imgproc 
...
ifeq ($(DEBUG), 1)
	...
	COMMON_FLAGS += -DNDEBUG -O2  -ffast-math -ftree-vectorize  -fopenmp
	#COMMON_FLAGS += -DNDEBUG -O2  -fopenmp
	#COMMON_FLAGS += -DNDEBUG -O2 -mfpu=neon -mfloat-abi=hard -fopenmp
	#COMMON_FLAGS += -DNDEBUG -O2 -mcpu=cortex-a15 -mfpu=neon-vfpv4 -mfloat-abi=hard -ffast-math -ftree-vectorize -mvectorize-with-neon-quad -fopenmp
endif
